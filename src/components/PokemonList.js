...
//   console.log(pokemons[0]);
  ...
  return (
    <div className="relative flex flex-wrap justify-evenly bg-black h-[100vh] w-full overflow-y-scroll">
      {pokemons?.map((pokemon) => (
        <div
          key={pokemon.id}
          className="relative h-40 w-40 flex flex-col m-4 justify-evenly items-center bg-gray-700/40 rounded-lg text-sand cursor-pointer"
